...
def run_program_and_get_register_0(filename):
    ...
    while True:
        ...
        print('ip={} {} {} {}'.format(before_ip, hexify(before_registers), instruction_line, hexify(registers)))

    return registers[0]

run_program_and_get_register_0('day21_input.txt')